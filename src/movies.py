...
class Movie:
    ...
    def __init__(self, name, rating, director, budget, description, actor: str = None, earnings: int = None, release_date: datetime = None):
        self.name = name
        self.rating = rating
...
TOY_STORY = Movie("ToyStory2", 4, "John Lasseter , Lee Unkrich , Ash Brannon", "90 millon USD",
                  "When Woody is toy-napped by a greedy toy collector and is nowhere to\
